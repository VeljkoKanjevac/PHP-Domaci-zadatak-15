...
<body>
    ...
    <form action="modeli/createProduct.php" method="post">
        ...
        <input required type="number" name="cena" placeholder="Unesite cenu proizvoda">
        <input required type="text" name="slika" placeholder="Unesite sliku proizvoda">
        <input required type="number" name="kolicina" placeholder="Unesite kolicinu proizvoda">
